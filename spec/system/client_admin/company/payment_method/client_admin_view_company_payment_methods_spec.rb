...
describe 'Admin view payment methods from company' do
  it 'successufuly' do
    ...
    payment_method_1 = PaymentMethod.create!(name: 'Nubank', payment_type: 0,
                                             bank_code: 260,
                                             tax: 1.0,
    ...
    company_payment_method = CompanyPaymentMethod.create!(
      ...
      company_id: client_admin.company.id
    )

    company_payment_method_2 = CompanyPaymentMethod.create!(payment_method: payment_method_2,
                                                            alpha_numeric_code: 'abc45678910121213142',
                                                            company_id: client_admin.company.id)

    company_payment_method_3 = CompanyPaymentMethod.create!(payment_method: payment_method_3, ag: '234',
                                                            bank_account: '999999', company_id: client_admin.company.id)
